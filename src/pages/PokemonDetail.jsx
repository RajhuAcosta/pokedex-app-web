    ...
    <div className="text-center capitalize">
      ...
      <main className="py-10 mt-8 px-2">
        <div className="max-w-[1000px] mx-auto" style={{boxShadow: "0px 2px 16px 0px rgba(0, 0, 0, 0.15)"}}>
          ...
          <div className="px-2 mt-3 text-black">
            {pokemon?.id<10?(<h3 className="text-xl font-bold" style={pokemon?.types.length>1?{background: `linear-gradient(to left, ${colorByType[pokemon?.types[1].type.name]} 0%, ${colorByType[pokemon?.types[0].type.name]} 90%)`, WebkitBackgroundClip: "text", color: "transparent"}:{color: `${colorByType[pokemon?.types[0].type.name]}`}}># 00{pokemon?.id}</h3>):(pokemon?.id<100?(<h3 className="text-xl font-bold" style={pokemon?.types.length>1?{background: `linear-gradient(to left, ${colorByType[pokemon?.types[1].type.name]} 0%, ${colorByType[pokemon?.types[0].type.name]} 90%)`, WebkitBackgroundClip: "text", color: "transparent"}:{color: `${colorByType[pokemon?.types[0].type.name]}`}}># 0{pokemon?.id}</h3>):(<h3 className="text-xl font-bold" style={pokemon?.types.length>1?{background: `linear-gradient(to left, ${colorByType[pokemon?.types[1].type.name]} 0%, ${colorByType[pokemon?.types[0].type.name]} 90%)`, WebkitBackgroundClip: "text", color: "transparent"}:{color: `${colorByType[pokemon?.types[0].type.name]}`}}># {pokemon?.id}</h3>))}
